...
export default function ProjectsPage() {
  ...
  const toggle = async (
    id: string,
    field: "is_favorite" | "is_template" | "archived",
    value: boolean,
  ) => {
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.tabs}>
        {(["active", "favorites", "templates", "archived"] as Tab[]).map(
          (t) => (
            <button
              key={t}
      ...
      {visible.length === 0 ? (
        <div className={styles.emptyState}>
          ...
          {tab === "favorites" && (
            <p>No favorite projects yet. Click the ★ on any project.</p>
          )}
          {tab === "templates" && (
            <p>No templates yet. Mark a project as a template to reuse it.</p>
          )}
          {tab === "active" && (
            <>
              <svg
        ...
        <div className={styles.grid}>
          {visible.map((project) => {
            ...
            return (
              <div
                key={project.id}
                className={`${styles.card} ${project.archived ? styles.cardArchived : ""}`}
              >
                <div
                  ...
                  >
                    <div className={styles.cardTop}>
                      <div className={styles.projectName}>
                        ...
                        {project.is_template && (
                          <span className={styles.badge} title="Template">
                            T
                          </span>
                        )}
                      </div>
                      ...
                      <div className={styles.actions} onClick={e => e.stopPropagation()}>
                        ...
                        <button
                          ...
                          onClick={() =>
                            toggle(project.id, "archived", !project.archived)
                          }
                    ...
                    <div className={styles.statsRow}>
                      ...
                      {project.hourly_rate > 0 && (
                        <>
                          ...
                          <div className={styles.stat}>
                            <span
                              className={`${styles.statVal} ${styles.rateVal}`}
                            >
