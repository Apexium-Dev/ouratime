...
export default function JoinPage() {
  ...
  const handleJoin = async () => {
    ...
    const { data, error: err } = await supabase.rpc("accept_workspace_invite", { invite_token: token });
    setJoining(false);
  ...
  if (loading) return (
    <div className={styles.page}>
      <div className={styles.card}><p className={styles.sub}>Loading…</p></div>
    </div>
  );
  ...
  if (!invite) return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>This invite link has expired or already been used.</p>
      </div>
    </div>
  );
  ...
  if (done) return (
    <div className={styles.page}>
      <div className={styles.card}>
        <div className={styles.icon}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#008080" strokeWidth="1.5" strokeLinecap="round">
  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        <div className={styles.icon}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#008080" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <p className={styles.sub}>
          Join <strong>{invite.workspaces?.name ?? "a workspace"}</strong> as <strong>{invite.role}</strong>
        </p>
